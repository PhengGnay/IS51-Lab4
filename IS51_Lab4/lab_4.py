...
question = "what is the capital of California". The answer in "Sacramento".

We first set max-tries = 3. Then we create a loop to iterate three times. For each iteration,
...
"""
main
    question = "What is the capital or California"
    answer = "California"
    ask(question, answer)
...
ask
    ...
    if not correct
        ...
        print the correct answer "The correct answer in 'California'"
